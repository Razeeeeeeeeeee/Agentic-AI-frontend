  ...
  return (
    <div className="min-h-screen bg-white relative">
      <div className="relative flex flex-col min-h-screen">
            ...
            <div className="flex flex-col items-center gap-0">
              <h1 className="text-8xl md:text-9xl font-normal leading-tight poly-regular">
                ...
                <div className="flex items-center gap-4 -mt-4">
                  <span className="poly-regular-italic text-red-400">
                    <Typewriter
                      options={{
                        strings: ['stress-free'],
                        autoStart: true,
              ...
              <div className="space-y-6 flex flex-col items-center w-full max-w-xl mx-auto">
                ...
                <Link href="/login" className="mt-8 bg-gray-900 text-white px-8 py-3 rounded-lg hover:bg-gray-800 transition-all text-xl group">
        ...
        >
          <div className="w-[400px] pl-20 flex-shrink-0 align-center">
            <h2 className="text-7xl font-normal leading-tight mb-12 poly-regular">
              <div className="text-gray-900">built for</div>
              <div className="-mt-4">
                <span className="poly-regular-italic text-red-400 hover:text-red-500 transition-all duration-300 cursor-pointer transform hover:-translate-y-1">busy people</span>
              </div>
            </h2>
            ...
            <div className="grid grid-cols-1 gap-2">
              <div 
                className="calendar-sync-card bg-gray-100 rounded-lg p-3 group hover:bg-red-50 hover:-translate-y-1 hover:shadow-lg transition-all duration-300 cursor-pointer"
              ...
              <div 
                className="company-insights-card bg-gray-100 rounded-lg p-3 group hover:bg-red-50 hover:-translate-y-1 hover:shadow-lg transition-all duration-300 cursor-pointer"
              ...
              <div 
                className="leetcode-card bg-gray-100 rounded-lg p-3 group hover:bg-red-50 hover:-translate-y-1 hover:shadow-lg transition-all duration-300 cursor-pointer"
              ...
              <div 
                className="ai-reminders-card bg-gray-100 rounded-lg p-3 group hover:bg-red-50 hover:-translate-y-1 hover:shadow-lg transition-all duration-300 cursor-pointer"
          ...
          <div className="flex-1 relative min-w-0 pr-8 ml-16">
            <div className="w-full h-[24rem] rounded-xl flex items-center justify-center sticky top-48 overflow-hidden mt-24">
              ...
              <div className={`absolute inset-0 transition-opacity duration-300 pointer-events-none ${hoveredFeature === 'calendar' ? 'opacity-100' : 'opacity-0'}`}>
                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[45%] h-[55%] border-2 border-red-500 rounded-lg" />
              </div>
              ...
              <div className={`absolute inset-0 transition-opacity duration-300 pointer-events-none ${hoveredFeature === 'insights' ? 'opacity-100' : 'opacity-0'}`}>
                <div className="absolute top-0 right-0 bottom-0 w-[25%] border-2 border-red-500 rounded-lg" />
              </div>
              ...
              <div className={`absolute inset-0 transition-opacity duration-300 pointer-events-none ${hoveredFeature === 'leetcode' ? 'opacity-100' : 'opacity-0'}`}>
                <div className="absolute top-0 left-0 bottom-0 w-[25%] border-2 border-red-500 rounded-lg" />
              </div>
        ...
        >
          ...
          <h2 className="text-7xl font-normal leading-tight mb-12 poly-regular">
            ...
            <br />
            <span className="poly-regular-italic text-red-400">more confidence</span>
          </h2>
        ...
        >
          ...
          <div className="max-w-4xl mx-auto px-6">
            <h2 className="text-7xl font-normal leading-tight mb-12 poly-regular">
              ...
              <span className="poly-regular-italic text-red-400">at a glance</span>
            </h2>
        ...
        >
          <h2 className="text-7xl font-normal leading-tight mb-12 poly-regular">
            ...
            <span className="poly-regular-italic text-red-400">today</span>
          </h2>
          ...
          <div className="flex gap-4 mt-8">
            <Link href="/login" className="bg-red-500 text-white px-6 py-3 rounded-lg hover:bg-red-600 transition-all text-lg group">
              Sign up <span className="transform transition-transform duration-200 group-hover:translate-x-1 inline-block">→</span>
            </Link>
            <Link href="/login" className="bg-white text-gray-900 px-6 py-3 rounded-lg border border-gray-200 hover:border-gray-300 transition-all text-lg group">
